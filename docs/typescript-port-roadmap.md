...
| `cloudflare` | `provide-uterm-cloudflare` (53 files, ~8.3k lines) | — | **partial** — the Worker configuration with its startup refusals, and the KV session registry; the Worker entry, Durable Object, transport, auth and routes outstanding |
