...
| `vnc` | `vnc` | `vnc` | **partial** — the RFB client-input filter, which is the boundary that stops a viewer typing into a session it may only watch; the human relay outstanding |
