...
| `bridge` | `bridge` worker side | `bridge` | **partial** — the authorization matrix, hijack coordinator, protocol contract and the hijackable worker primitives; worker link outstanding |
