...
| 2026-07-31 | Browser quality fix-forward | Node 22 frontend/app isolated builds, typechecks, warning-fatal lint, and coverage | pass at `c9d265dc`; frontend 552 tests and 94.09/85.79/92.90/95.58% against 90/85/90/90; app 369 tests and 94.18/81.27/96.04/96.98% against 90/80/90/90; independent review pending |
...
| 2026-07-31 | Python approval expiry/fan-out truthfulness fix-forward | normal package-CWD strict suite in one invocation; 268 focused compatibility tests; Ruff/format/hooks | pass at `e32c8a39`: 6,763 passed, 2 deselected; 100% of 13,533 statements and 3,626 branches; independent acceptance pending |
| 2026-07-31 | Python rejected-resume authority closure | 76 focused server and 20 mirrored core tests; normal strict server suite; Ruff/Mypy/ty/hooks | pass at `ff1955d4`: 6,773 passed, 2 deselected; 100% of 13,558 statements and 3,638 branches; independent final review pending |
| 2026-07-31 | Cloudflare lifecycle fix-forward | full non-e2e suite; clean-PATH Node 22 pywrangler/workerd adapter; focused fencing/regex; Ruff/Mypy/Bandit | pass in combined commit `5793a7b3`: 1,618 passed, 61 skipped; real adapter passed in 61.23s with hibernation, replacement pause, owned delivery, heartbeat identity, invalid-regex zero-frame, and resume-disabled proof; independent re-review pending |
| 2026-07-31 | Cloudflare final lifecycle/regex/coverage closure | prescribed strict package suite; native Node 22 pywrangler/workerd lifecycle adapter; Ruff/Mypy/Bandit/hooks | pass at `196008a8`: 1,681 passed, 61 skipped; 100% of 4,188 statements and 1,452 branches; omitted-lower counted quantifiers, alternation, and all lookaround forms reject with zero worker frames; independent final review pending |
...
| 2026-07-31 | Fan-out documentation truth | ARD and security/protocol matrices reviewed against served implementations | all five operations global-admin-only; served, unserved, and explicitly unsupported policy surfaces distinguished; FANOUT-001 through FANOUT-005 remain in review |
| 2026-07-31 | Go lifecycle fence (superseded checkpoint) | `python3 scripts/run_session_lifecycle_security_scenarios.py --backend go`; `GOWORK=off go test ./... -count=1`; `GOWORK=off go test -race ./hub ./server -count=1`; `GOWORK=off go vet ./...` | tests passed at `f71d34e2`, but independent concurrency review rejected the checkpoint; eight lifecycle, delivery-truthfulness, and approval ABA findings remain open pending a fix-forward commit and re-review |
| 2026-07-31 | Go lifecycle fix-forward | lifecycle adapter; `GOWORK=off go test ./... -count=1`; focused and full `GOWORK=off go test -race ./...`; `GOWORK=off go vet ./...` | pass at `25d86f2a`; deterministic release/acquire, replacement/disconnect, resume, approval ABA/partial replay/order, tunnel-step, and writer-cancellation regressions green; independent follow-up review still required |
...
| 2026-07-31 | Python approval ABA final closure | 119 focused implementation tests; normal strict server suite; independent 113-test review | independently approved at `4219b154`: 6,774 passed, 2 deselected; 100% of 13,564 statements and 3,640 branches; delayed rev1 cleanup preserves releasable rev2 fan-out state |
