...
| 2026-08-01 | Final conformance suite | `GOWORK=off uv run pytest -q tests/conformance/ -o addopts=--import-mode=importlib` | 219 passed in 90.70s, including the four new contract-shape category tests and the real four-backend runner |
