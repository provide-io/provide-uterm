...
| 2026-08-01 | Final conformance suite | `GOWORK=off uv run pytest -q tests/conformance/ -o addopts=--import-mode=importlib` | 215 passed in 68.13s, including the `d092f5d0` adapter-timeout test and a new test pinning the 120-second default adapter bound |
