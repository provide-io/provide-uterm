...
from provide.terminal.control_stream import ControlStreamProtocolError, encode_data
...
from provide.terminal.hijack.rest_helpers import compile_expect_regex
...
class TestBridgeRecvLoopProtocolError:
    ...
    async def test_protocol_error_causes_recv_loop_return(self) -> None:
        ...
        from provide.terminal.control_stream import ControlStreamDecoder
...
class TestBrowserHandlersResumeReclaimFail:
    ...
    async def test_resume_reclaim_fails_when_open_mode_active(self) -> None:
        ...
        """
        from provide.terminal.hijack.hub.resume import InMemoryResumeStore
        from provide.terminal.hijack.routes.browser_handlers import _handle_resume
