...
from provide.terminal.hijack.routes_rest import register_rest_routes as register_rest_routes
from provide.terminal.hijack.routes_ws import register_ws_routes as register_ws_routes
