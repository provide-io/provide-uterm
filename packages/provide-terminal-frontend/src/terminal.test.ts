...
describe("ProvideTerminal construction", () => {
  ...
  it("mounts DOM into container", async () => {
    ...
    expect(container.querySelector(".provide-terminal")).toBeTruthy();
  });
...
describe("ProvideTerminal disconnect / dispose", () => {
  ...
  it("dispose removes DOM from container", async () => {
    ...
    terminal.dispose();
    expect(container.querySelector(".provide-terminal")).toBeFalsy();
  });
...
describe("ProvideTerminal settings", () => {
  it("loads settings from localStorage when present", async () => {
    ...
    const { container } = await makeTerminal();
    const root = container.querySelector(".provide-terminal")!;
  ...
  it("theme buttons switch theme (bbs)", async () => {
    ...
    bbsBtn.click();
    expect(container.querySelector(".provide-terminal")?.classList.contains("theme-bbs")).toBe(true);
  });
  ...
  it("theme buttons switch theme (glass)", async () => {
    ...
    glassBtn.click();
    expect(container.querySelector(".provide-terminal")?.classList.contains("theme-glass")).toBe(true);
  });
  ...
  it("theme buttons switch theme (code)", async () => {
    ...
    codeBtn.click();
    expect(container.querySelector(".provide-terminal")?.classList.contains("theme-code")).toBe(true);
  });
  ...
  it("pageBg color input updates CSS variable", async () => {
    ...
    const root = container.querySelector<HTMLElement>(".provide-terminal")!;
