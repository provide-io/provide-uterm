# provide-terminal-frontend

Browser UI for the [provide-terminal](../../README.md) platform. Vanilla TypeScript — no React, no framework.
...
```bash
cd packages/provide-terminal-frontend
npx vitest run
```
