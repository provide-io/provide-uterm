...
// data directly (the frame IS the command). The lease/permission gate
// (prepare_browser_input) is likewise not applied here — see the deviation note
// on handleBrowserWS. Both keep the interop hold→approve/reject behaviour intact.
