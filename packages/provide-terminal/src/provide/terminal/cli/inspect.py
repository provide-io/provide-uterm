...
Example::
    ...
    uterm inspect 8080 --server https://warp.provide.io --display-name "my-api"
"""
...
async def _run_inspect(
    ...
    *,
    ...
    from provide.terminal.tunnel.intercept import InterceptGate, parse_action_message
    ...
    async def _ws_action_receiver() -> None:
        ...
        from provide.terminal.tunnel.protocol import decode_frame
