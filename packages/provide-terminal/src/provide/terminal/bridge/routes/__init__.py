...
Mount via :meth:`~provide.terminal.bridge.hub.TermHub.create_router`::
...
from provide.terminal.bridge.routes.rest import register_rest_routes as register_rest_routes
from provide.terminal.bridge.routes.websockets import register_ws_routes as register_ws_routes
