...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_cli.py -v --no-cov`
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_app.py -v --no-cov`
Expected: ImportError
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_integration.py -v --no-cov`
Expected: all PASS
