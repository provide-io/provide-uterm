...
- Modify: `packages/provide-terminal/pyproject.toml`

- Create: `packages/provide-terminal/src/provide/terminal/cli/watch.py`

- Modify: `packages/provide-terminal/src/provide/terminal/cli/__init__.py`

- Test: `packages/provide-terminal/tests/tunnel/test_watch_cli.py`

- [ ] **Step 1: Add textual to pyproject.toml cli extra**

In `packages/provide-terminal/pyproject.toml`, change line 42:
...
```python
# packages/provide-terminal/tests/tunnel/test_watch_cli.py
#
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_cli.py -v --no-cov` Expected: ImportError
...
Example::
    ...
    uterm watch tunnel-abc123 --server https://warp.provide.io
    uterm watch https://warp.provide.io/app/inspect/tunnel-abc --layout vertical
"""
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_cli.py -v --no-cov` Expected: all PASS

- [ ] **Step 7: Commit**

```bash
git add packages/provide-terminal/pyproject.toml \
       packages/provide-terminal/src/provide/terminal/cli/watch.py \
...
- Create: `packages/provide-terminal/src/provide/terminal/cli/_watch_app.py`

- Test: `packages/provide-terminal/tests/tunnel/test_watch_app.py`

- [ ] **Step 1: Write tests for WS message parsing logic**

```python
# packages/provide-terminal/tests/tunnel/test_watch_app.py
#
# SPDX-FileCopyrightText: Copyright (c) 2025-2026 provide.io llc. All rights reserved.
# SPDX-License-Identifier: AGPL-3.0-or-later
#
...
from provide.terminal.cli._watch_app import Exchange, parse_http_frames, human_size, status_style
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_app.py -v --no-cov` Expected: ImportError
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_app.py -v --no-cov` Expected: all PASS

- [ ] **Step 5: Commit**

```bash
git add packages/provide-terminal/src/provide/terminal/cli/_watch_app.py \
       packages/provide-terminal/tests/tunnel/test_watch_app.py
...
- Test: `packages/provide-terminal/tests/tunnel/test_watch_integration.py`

- [ ] **Step 1: Write integration test for watch data flow**

```python
# packages/provide-terminal/tests/tunnel/test_watch_integration.py
#
# SPDX-FileCopyrightText: Copyright (c) 2025-2026 provide.io llc. All rights reserved.
# SPDX-License-Identifier: AGPL-3.0-or-later
#
...
from provide.terminal.cli._watch_app import Exchange, parse_http_frames, _decode_body
...
Run: `uv run pytest packages/provide-terminal/tests/tunnel/test_watch_integration.py -v --no-cov` Expected: all PASS
...
```bash
git add packages/provide-terminal/tests/tunnel/test_watch_integration.py
