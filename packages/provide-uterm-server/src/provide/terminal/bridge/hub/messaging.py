...
from provide.terminal.bridge.frames import make_hijack_state_frame, make_worker_disconnected_frame
...
if TYPE_CHECKING:
    ...
    from provide.terminal.bridge.frames import HijackStateFrame
    from provide.terminal.bridge.hub.resume import ResumeTokenStore
...
class HubMessagingMixin:
    ...
    async def _send_hijack_state_to(
        ...
        *,
        ...
        from provide.terminal.bridge.hub.core import _encode_browser_frame, _mono_to_wall
    ...
    async def _audit_all_browsers(self) -> None:
        ...
        from provide.terminal.bridge.hub.ext import ConnectionHeuristics
    ...
    async def hijack_state_msg_for(self, worker_id: str, ws: WebSocket) -> HijackStateFrame:
        ...
        from provide.terminal.bridge.hub.core import _mono_to_wall
