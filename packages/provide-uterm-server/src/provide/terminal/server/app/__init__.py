...
single-file ``provide.terminal.server.app`` module.  The implementation is
...
# ``provide.terminal.server.app.importlib.resources.files`` continues to work
# unchanged after the package split.
import importlib.resources

from provide.terminal.server.app.assets import _validate_frontend_assets
...
from provide.terminal.server.app.factory import create_server_app
