...
class PamTunnelBridge:
    ...
    async def start(self) -> None:
        from provide.uterm.tunnel.client import TunnelClient
    ...
    async def _tunnel_to_pty_loop(self, master_fd: int) -> None:
        from provide.uterm.tunnel.protocol import CHANNEL_DATA
    ...
    async def _capture_to_tunnel_loop(self) -> None:
        from provide.uterm.pty.capture import CHANNEL_STDOUT
