...
Mount via :meth:`~provide.uterm.server.bridge.hub.TermHub.create_router`::
...
from provide.uterm.server.bridge.routes.rest import register_rest_routes as register_rest_routes
from provide.uterm.server.bridge.routes.websockets import register_ws_routes as register_ws_routes
