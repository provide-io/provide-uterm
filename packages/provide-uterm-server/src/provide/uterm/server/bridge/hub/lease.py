...
enforcement is deferred — see the lease.py note in
``[tool.mutmut].paths_to_mutate`` — pending a fix to a mutmut-internal
child-reaping crash, not for any coverage gap.)
