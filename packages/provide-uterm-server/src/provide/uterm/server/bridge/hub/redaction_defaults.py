...
The :class:`~provide.uterm.server.bridge.hub.redaction.StreamRedactor` is rule-driven
...
Every rule is a :class:`~provide.uterm.server.bridge.hub.ext.RedactionRule` with a
