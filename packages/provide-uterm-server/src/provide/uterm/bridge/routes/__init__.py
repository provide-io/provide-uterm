...
Mount via :meth:`~provide.uterm.bridge.hub.TermHub.create_router`::
...
from provide.uterm.bridge.routes.rest import register_rest_routes as register_rest_routes
from provide.uterm.bridge.routes.websockets import register_ws_routes as register_ws_routes
