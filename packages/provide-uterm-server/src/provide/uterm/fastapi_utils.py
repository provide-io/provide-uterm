...
Usage — telnet client → remote WS gateway::
    ...
    from provide.uterm.fastapi_utils import TelnetWsGateway
...
if TYPE_CHECKING:
    ...
    from provide.uterm.protocols import TerminalReader, TerminalWriter
...
def create_ws_terminal_router(
    ...
    *,
    ...
    2. Wraps the socket in :class:`~provide.uterm.transports.websocket.WebSocketStreamReader`
       and :class:`~provide.uterm.transports.websocket.WebSocketStreamWriter`.
...
class WsTerminalProxy:
    ...
    server via any :class:`~provide.uterm.transports.base.ConnectionTransport`
    ...
    Args:
        ...
        transport_factory: Zero-argument callable that returns a fresh
            ...
            Defaults to :class:`~provide.uterm.transports.telnet.TelnetTransport`.
