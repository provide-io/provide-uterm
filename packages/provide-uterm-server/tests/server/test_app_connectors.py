...
#
"""Unit tests for ``provide.uterm.server.app.connectors``.
...
def test_external_connector_loads_real_module(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level(logging.INFO, logger="provide.uterm.server.app.connectors"):
...
def test_external_connector_missing_module_logs_error(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level(logging.ERROR, logger="provide.uterm.server.app.connectors"):
