...
class TestMcpCliMain:
    ...
    def test_main_parses_url(self) -> None:
        ...
        with patch("provide.uterm.ai.server.create_mcp_app", return_value=mock_app) as mock_create:
    ...
    def test_main_calls_app_run_with_stdio(self) -> None:
        ...
        with patch("provide.uterm.ai.server.create_mcp_app", return_value=mock_app):
            main(["--url", "http://test"])
    ...
    def test_main_uses_sys_argv_when_argv_is_none(self) -> None:
        ...
        with (
            ...
            patch("provide.uterm.ai.server.create_mcp_app", return_value=mock_app) as mock_create,
        ):
            main(None)
