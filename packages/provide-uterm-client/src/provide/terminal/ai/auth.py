...
2. Looks up the tool's required role in
   :mod:`provide.terminal.ai.policy`.
...
:data:`~provide.terminal.ai.policy.TOOL_REQUIRED_ROLES` entry; otherwise
...
from provide.terminal.ai.policy import Role, required_role, role_at_least
...
class McpPrincipal:
    ...
    Mirrors the fields used by ``provide.terminal.server.auth.Principal``
    ...
    def primary_role(self) -> str:
        ...
        from provide.terminal.ai.policy import role_rank
