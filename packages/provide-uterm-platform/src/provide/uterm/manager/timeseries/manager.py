...
from provide.uterm.manager.constants import EPOCH_TURN_DROP_MIN, EPOCH_TURN_DROP_RATIO

if TYPE_CHECKING:
    from provide.uterm.manager.protocols import TimeseriesPlugin
...
class TimeseriesManager:
    ...
    :class:`~provide.uterm.manager.protocols.TimeseriesPlugin`.
    """
    ...
    def __init__(
        ...
        *,
        ...
        from provide.uterm.manager.constants import TIMESERIES_MAX_BYTES, TIMESERIES_RETENTION_S
