...
from provide.terminal.cloudflare.entry import auth as _auth_mod
from provide.terminal.cloudflare.entry.auth import _require_jwt, _resolve_principal_id
from provide.terminal.cloudflare.entry.fallback_stubs import CloudflareConfig, Response, json_response
from provide.terminal.cloudflare.entry.share_tokens import _attach_share_token_cookie
from provide.terminal.cloudflare.entry.spa import _resolve_spa_route, _spa_response

logger = logging.getLogger(__name__)


def _entry_attr(name: str) -> Any:
    """Resolve ``provide.terminal.cloudflare.entry.<name>`` lazily.

    Tests patch ``provide.terminal.cloudflare.entry.<name>`` (the package
    ...
    """
    from provide.terminal.cloudflare import entry as _entry_pkg
...
async def _decode_jwt_principal(request: object, config: CloudflareConfig) -> Any:
    ...
    Indirection via :mod:`provide.terminal.cloudflare.entry.auth` keeps tests
