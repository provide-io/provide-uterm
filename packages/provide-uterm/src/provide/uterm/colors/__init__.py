...
``upgrade_to_truecolor`` in :mod:`provide.uterm.ansi`. Organized as
...
Consumers should import from the subpackage root:
    ...
    from provide.uterm.colors import apply_color_mode, rgb_to_256

or from the package root:

    from provide.uterm import apply_color_mode
"""
