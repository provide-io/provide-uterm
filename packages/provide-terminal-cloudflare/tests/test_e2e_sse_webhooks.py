...
Run with:
    uv run pytest -m e2e packages/provide-terminal-cloudflare/tests/test_e2e_sse_webhooks.py
or:
    E2E=1 uv run pytest packages/provide-terminal-cloudflare/tests/
...
_HTTP_UA = "provide-terminal-e2e-test/1.0"
