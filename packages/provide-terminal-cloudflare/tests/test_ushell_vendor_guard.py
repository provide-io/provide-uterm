...
If this test fails, run:
  uv pip install --python .venv-workers/pyodide-venv/bin/python --reinstall /path/to/provide-terminal-shell
...
def test_ushell_vendor_tree_exists() -> None:
    ...
    assert ushell_path.exists() and ushell_path.is_dir(), (
        ...
        "--reinstall /path/to/provide-terminal-shell && pywrangler sync --force"
    )
