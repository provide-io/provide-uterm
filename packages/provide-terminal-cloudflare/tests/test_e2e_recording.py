...
Run with:
    uv run pytest -m e2e packages/provide-terminal-cloudflare/tests/test_e2e_recording.py
or:
    E2E=1 uv run pytest packages/provide-terminal-cloudflare/tests/test_e2e_recording.py
...
_WS_TIMEOUT_S = 0.5
_WS_PROCESS_S = 1.0
_HTTP_UA = "provide-terminal-e2e-recording/1.0"
