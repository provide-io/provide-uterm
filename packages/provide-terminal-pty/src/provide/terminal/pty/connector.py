...
from provide.terminal.pty.pam import PamSession
from provide.terminal.pty.uid_map import ResolvedUser, UidMap
...
def _register() -> None:
    ...
    try:
        from provide.terminal.server.connectors.registry import register_connector
    ...
    connectors = sys.modules.get("provide.terminal.server.connectors")
