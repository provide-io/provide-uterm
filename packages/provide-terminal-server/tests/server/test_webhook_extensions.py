...
async def test_authz_service_fallback_paths() -> None:
    ...
    class MinimalProvider:
        ...
        async def can_read_recording(self, principal: Principal, session: SessionDefinition) -> bool: return True
        async def can_create_session(self, principal: Principal) -> bool: return True
        async def can_read_profile(self, principal: Principal, profile: ConnectionProfile) -> bool: return True
        async def can_mutate_profile(self, principal: Principal, profile: ConnectionProfile) -> bool: return True
