...
import { asThemeName, buildThemeButtonsHtml, type ThemeName } from "./terminal-themes.js";
...
export const DEFAULTS: TerminalSettings = {
  theme: "code",
  cols: 80,
  rows: 25,
  fontSize: 14,
...
export const GEAR_SVG: TemplateResult =
 ...
 */
export function buildSettingsPanelHtml(uid: number): TemplateResult {
  return html`
