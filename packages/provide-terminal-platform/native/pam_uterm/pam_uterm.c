/* packages/provide-terminal-platform/native/pam_uterm/pam_uterm.c
 * SPDX-FileCopyrightText: Copyright (c) 2025-2026 provide.io llc. All rights reserved.
 * SPDX-License-Identifier: AGPL-3.0-or-later
 *
 * PAM session module for provide-terminal daemon bridge.
 *
 * Install:
 ...
 * even if the provide-terminal daemon is not running.
 */
