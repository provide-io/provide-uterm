...
internal static class FrameMapper
{
    public static Dictionary<string, object?> ToDict(IFrame frame) => frame switch
    {
        ...
        SnapshotFrame f => Dict(
            ...
            Opt("raw_tail", f.RawTail),
            Opt("chunks_read", f.ChunksRead), Opt("bytes_read", f.BytesRead),
            Opt("ts", f.Ts)),
        ...
        HelloFrame f => Dict(
            ...
            Opt("resume_supported", f.ResumeSupported),
            Opt("mcp_supported", f.McpSupported), Opt("vnc_supported", f.VncSupported),
            Opt("resume_token", f.ResumeToken),
    ...
    public static IFrame FromJson(JsonElement root, string type)
    {
        ...
        return type switch
        {
            ...
            FrameTypeNames.Snapshot => new SnapshotFrame
            {
                ...
                RawTail = S("raw_tail"),
                ChunksRead = I("chunks_read"),
                BytesRead = I("bytes_read"),
                Ts = D("ts"),
            },
        ...
        Func<string, Dictionary<string, object?>?> Obj)
    {
        ...
        return new HelloFrame
        {
            ...
            McpSupported = B("mcp_supported"),
            VncSupported = B("vnc_supported"),
