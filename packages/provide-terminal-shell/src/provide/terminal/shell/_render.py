...
#
"""Image-to-ANSI rendering — delegates to provide.terminal.render.

Requires ``provide-terminal-shell[images]`` extra.
"""
...
try:
    ...
    from provide.terminal.render.image import render_frame as _render_frame
    ...
    raise ImportError(  # pragma: no cover
        "missing dependency — provide-terminal-render\ninstall the images extra: pip install 'provide-terminal-shell[images]'"
    ) from None
