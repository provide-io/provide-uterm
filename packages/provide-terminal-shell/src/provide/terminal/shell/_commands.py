...
render [flags] <url>    — render image as ANSI art (requires provide-terminal-shell[images])
...
_COMMAND_HELP: dict[str, str] = {
    ...
    "render": (
        ...
        "  Requires: pip install 'provide-terminal-shell[images]'\r\n"
    ),
    ...
    async def _cmd_render(self, arg: str) -> list[str] | AnimatedResult:
        ...
        try:
            if url.startswith("file://"):
                ...
                req = urllib.request.Request(url, headers={"User-Agent": "provide-terminal-shell/1.0"})  # noqa: S310
