...
**What you'll see:** The demo posts a series of annotations to a live session, then opens the
replay viewer to step through each labeled entry. Every annotation shows its event type,
timestamp, and any auto-detected pattern match.
