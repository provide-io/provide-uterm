...
**What you'll see:** Nine fleet workers start up and register themselves. A deploy command is
broadcast to all nine simultaneously. Each worker executes it and responds. The recording
shows the full lifecycle: workers coming online, grouping under a single fleet, and receiving
the coordinated command.
