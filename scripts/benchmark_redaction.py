...
def benchmark():
    ...
    data = "Here is some sensitive data: sk_live_ABC123456789, a card 1234-5678-9012-3456, an email test@example.com, a key AIzaSyA12345678901234567890123456789012, and a JWT eyJhYmMi.eyJhYmMi.YWJj. " * 100
