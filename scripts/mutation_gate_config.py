...
BRIDGE_HUB_SOURCE_PATHS: Final[frozenset[str]] = frozenset(
    {
        ...
        "src/provide/uterm/server/bridge/routes/browser_handlers.py",
        "src/provide/uterm/server/bridge/hub/resume.py",
        "src/provide/uterm/server/bridge/routes/websockets_browser.py",
        "src/provide/uterm/server/bridge/routes/websockets_worker.py",
        "src/provide/uterm/server/bridge/routes/rest_workerctl.py",
        "src/provide/uterm/server/bridge/routes/rest.py",
        "src/provide/uterm/server/bridge/routes/websockets_impl.py",
        "src/provide/uterm/server/bridge/hub/core_delegates_lease.py",
        "src/provide/uterm/server/bridge/hub/core_delegates_connection.py",
        "src/provide/uterm/server/bridge/hub/semantics.py",
        "src/provide/uterm/server/bridge/hub/redaction.py",
        "src/provide/uterm/server/bridge/hub/redaction_defaults.py",
        "src/provide/uterm/server/bridge/hub/core_helpers.py",
        "src/provide/uterm/server/bridge/hub/connections.py",
...
BRIDGE_HUB_MUTATION_TESTS: Final[tuple[str, ...]] = (
    ...
    "packages/provide-uterm-server/tests/bridge/test_browser_handlers_mutations.py",
    "packages/provide-uterm-server/tests/bridge/test_browser_handlers_coverage.py",
    "packages/provide-uterm-server/tests/bridge/test_browser_handlers_resume.py",
    "packages/provide-uterm-server/tests/bridge/test_try_reclaim_hijack_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_input_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_resume_gates_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_resume_success_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_hijack_request_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_hijack_step_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_hijack_release_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_handle_browser_message_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_browser_handlers_small_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rollback_reclaimed_hijack_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_inspect_and_analyze_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_resume.py",
    "packages/provide-uterm-server/tests/bridge/test_resume_consume_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_resume_control_plane_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_dispatch_browser_event_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_resume_worker_on_disconnect_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_build_worker_frame_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_worker_hello_and_dispatch_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_workerctl_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_hijack_acquire_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_hijack_send_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_hijack_step_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_hijack_release_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_hijack_lease_reads_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_worker_term_early_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_worker_term_loop_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_browser_term_early_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_browser_term_loop_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/hub/test_core_delegates_kill.py",
    "packages/provide-uterm-server/tests/bridge/hub/test_semantics_kill.py",
    "packages/provide-uterm-server/tests/bridge/hub/test_redaction_kill.py",
    "packages/provide-uterm-server/tests/bridge/hub/test_core_helpers_kill.py",
    "packages/provide-uterm-server/tests/bridge/test_bridge.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_browser.py",
    "packages/provide-uterm-server/tests/server/test_ws_denial_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_resume.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_resume_2.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_regression.py",
    "packages/provide-uterm-server/tests/bridge/test_websockets_coverage.py",
    "packages/provide-uterm-server/tests/bridge/test_ws.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_regression_disconnect.py",
    "packages/provide-uterm-server/tests/bridge/test_worker_hello_protocol.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_exception_handling.py",
    "packages/provide-uterm-server/tests/bridge/test_worker_frame_validation.py",
    "packages/provide-uterm-server/tests/bridge/test_limits.py",
    "packages/provide-uterm-server/tests/bridge/test_semantics.py",
    "packages/provide-uterm-server/tests/bridge/test_redaction_defaults.py",
    "packages/provide-uterm-server/tests/bridge/test_connections_coverage.py",
    "packages/provide-uterm-server/tests/bridge/test_hub_mutation_killing.py",
    "packages/provide-uterm-server/tests/bridge/test_routes.py",
    "packages/provide-uterm-server/tests/bridge/test_routes_coverage.py",
    "packages/provide-uterm-server/tests/bridge/test_routes_regression.py",
    "packages/provide-uterm-server/tests/bridge/test_rest_lease_ownership.py",
    "packages/provide-uterm-server/tests/bridge/test_acquire_atomic.py",
    "packages/provide-uterm-server/tests/bridge/test_hub_routes_coverage.py",
    "packages/provide-uterm-server/tests/bridge/test_owned_input_fencing.py",
    "packages/provide-uterm-server/tests/bridge/test_shared_input.py",
    "packages/provide-uterm-server/tests/bridge/test_ws_routes_coverage.py",
    "packages/provide-uterm-server/tests/bridge/hub/test_security_audit.py",
    "packages/provide-uterm-server/tests/server/test_route_coverage.py",
    "packages/provide-uterm-server/tests/server/test_api_auth_part1.py",
    "packages/provide-uterm-server/tests/bridge/test_snapshot_ingest_counters.py",
    "packages/provide-uterm-server/tests/bridge/test_unsolicited_snapshot_integration.py",
    "packages/provide-uterm-server/tests/bridge/test_snapshot_event_correlation.py",
