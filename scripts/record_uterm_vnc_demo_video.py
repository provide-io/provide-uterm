...
from vnc_demo_storyboard import record_storyboard  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        frame_paths, metrics, storyboard, metrics_path, full_png, desktop_png = record_storyboard(
            evidence=evidence,
            shots=shots,
            base=base,
            headers=headers,
            ...
            page_url=page_url,
            lines=lines,
            tail_seconds=float(args.seconds),
            chapters=LIVE_DEMO_CHAPTERS,
            key_gap_s=_KEY_GAP_S,
            lab_name=LAB,
            send_shell_keys=send_shell_keys,
        )
